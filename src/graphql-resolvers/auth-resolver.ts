...
import {Credentials, LoginResponse, RegistrationResponse, UserData} from '../models/auth';
...
export class AuthResolver {
  ...
  async register(@arg('userData') userData: UserData): Promise<RegistrationResponse> {
  ...
  async login(@arg('credentials') credentials: Credentials): Promise<LoginResponse> {
